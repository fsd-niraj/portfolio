...
const WriteupCard = ({ date, title, subTitle, href }: { date: string; title: string; subTitle: string; href: string }) => (
  <a
    href={href}
  ...
  >
    ...
    <div className="w-full">
      ...
      <p className="text-muted text-md">{subTitle}</p>
    </div>
  </a>
)
    ...
    <ScrollReveal>
      <div className="py-4">
        <div className="flex flex-col gap-1 group">
          <h2 className="mb-4 text-xs uppercase tracking-widest text-muted">writings</h2>
